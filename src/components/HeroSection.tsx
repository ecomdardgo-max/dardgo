...
export function HeroSection() {
  return (
    <section className="relative isolate overflow-hidden bg-mesh-hero bg-grain flex items-center">
      {/* Layered background */}
      ...
      <div className="absolute top-[8%] right-[8%] w-72 h-72 rounded-full bg-brand-yellow/15 blur-[100px] animate-orb-drift hidden md:block" />
      <div
        className="absolute bottom-[10%] left-[10%] w-96 h-96 rounded-full bg-brand-green-light/15 blur-[120px] animate-orb-drift hidden md:block"
      ...
      <div className="relative mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 lg:pt-8 pb-10 sm:pb-14 lg:pb-16 w-full">
        <div className="flex flex-col items-center text-center w-full">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 mb-3 sm:mb-4 px-3 py-1.5 rounded-full bg-white/8 backdrop-blur-md border border-white/15"
          >
            <span className="relative flex h-2 w-2">
              <span className="absolute inline-flex h-full w-full rounded-full bg-brand-yellow opacity-70 animate-ping" />
          ...
          <motion.h1
            ...
            className="text-display-2 text-white mb-3 sm:mb-4 max-w-3xl"
          >
            Pure Ayurvedic{" "}
          ...
          <motion.div
            ...
            className="relative w-full my-6 sm:my-8 lg:my-10"
          >
            {/* Glow halo behind image */}
            <div className="absolute inset-0 flex items-center justify-center -z-10 pointer-events-none">
              <div className="w-[85%] h-[85%] rounded-full bg-gradient-to-br from-brand-yellow/25 to-brand-green-light/15 blur-3xl" />
            </div>
            ...
            <img
              ...
              loading="eager"
              fetchPriority="high"
              className="relative w-full h-auto mx-auto object-contain drop-shadow-[0_40px_80px_rgba(0,0,0,0.5)]"
            />
          </motion.div>
