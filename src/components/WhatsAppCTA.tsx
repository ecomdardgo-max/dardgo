      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-hero rounded-3xl p-8 sm:p-14 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <p className="text-xs sm:text-sm font-bold tracking-widest uppercase mb-3" style={{ color: '#FFD700' }}>Quick & Easy Ordering</p>
            <h2 className="text-2xl sm:text-4xl font-bold font-[var(--font-display)] mb-4" style={{ color: '#fff' }}>
              Order on WhatsApp
            </h2>
            <p className="text-sm sm:text-base mb-8 max-w-md mx-auto" style={{ color: 'rgba(255,255,255,0.8)' }}>
