...
import termsConditionsMd from "@/content/terms-conditions.md?raw";

const termsBody = termsConditionsMd
  .replace(/^\uFEFF/, "")
  .replace(/\r\n/g, "\n")
  .replace(/^<!--[\s\S]*?-->\s*\n?/, "");
...
export const Route = createFileRoute("/terms-conditions")({
  ...
  head: () => ({
    meta: [
      { title: "Terms & Conditions | DARDGO" },
      {
        name: "description",
        content:
          "Terms of Service for Dardgo Pharma Private Limited — online store, purchases, and use of dardgo.com services.",
      },
    ],
  }),
});
