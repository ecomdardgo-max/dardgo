...
import returnsRefundMd from "@/content/returns-refund.md?raw";

const returnsBody = returnsRefundMd
  .replace(/^\uFEFF/, "")
  .replace(/\r\n/g, "\n")
  .replace(/^<!--[\s\S]*?-->\s*\n?/, "");
...
export const Route = createFileRoute("/returns-refund")({
  component: ReturnsRefundPage,
  head: () => ({
    meta: [
      { title: "Return / Refund Policy | DARDGO" },
      {
        name: "description",
        content:
          "DARDGO return and refund policy — 30-day returns, eligibility, exchanges, EU cooling-off, and refunds.",
      },
    ],
  }),
});
          ...
          <ScrollReveal>
            <div className="text-center mb-8 sm:mb-10">
              ...
              <h1 className="text-3xl sm:text-4xl font-bold text-foreground mb-3 break-words">
                Returns & <span className="text-gradient-green">Refund</span>
              </h1>
            </div>
          </ScrollReveal>
