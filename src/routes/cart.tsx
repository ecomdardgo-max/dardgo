...
export const Route = createFileRoute("/cart")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Review your DARDGO Ayurvedic products cart and proceed to checkout.",
      },
    ],
  }),
});
...
function CartPage() {
  ...
  const handleCheckout = () => {
    ...
    if (isShiprocketCheckoutConfigured()) {
      navigate({
        to: "/checkout",
        state: { checkoutCoupon: coupon.trim() || undefined },
      });
      return;
    }
                  ...
                  {items.map((item) => (
                    ...
                    >
                        ...
                        <div className="mt-auto flex items-center justify-between gap-2">
                          ...
                          <div className="flex items-center gap-1 bg-muted/60 rounded-xl p-1">
                            <button
                              ...
                              className="h-7 w-7 sm:h-8 sm:w-8 rounded-lg flex items-center justify-center hover:bg-card transition-colors"
                            >
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-lg text-muted-foreground hover:text-destructive hover:bg-destructive/5 transition-colors self-start flex-shrink-0"
                      >
              ...
              <div>
                <div className="lg:sticky lg:top-24 bg-card rounded-3xl p-5 sm:p-6 shadow-card border border-border/30">
                  ...
                  <div className="space-y-3 mb-5 text-sm">
                    ...
                    <div className="border-t border-border/50 pt-3 flex justify-between text-base">
                      ...
                      <span className="font-bold text-lg">
                        ₹{(totalPrice + (freeShipping ? 0 : 40)).toFixed(0)}
                      </span>
                    </div>
                  </div>
                  ...
                  {isShiprocketCheckoutConfigured() ? (
                    <BuyNowShiprocketBar onClick={handleCheckout} disabled={isLoading} />
                  ) : (
                    <button
                      type="button"
